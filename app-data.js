  ...
  workTypes: [
    {
      ...
      workflowAdmin: {
        workflowFile: ".github/workflows/defect-delivery.yml",
        activationState: "active",
        retryCount: 2,
        maxConcurrency: 2,
        triggerConditions: "DEF prefix, bug semantics, reproduction fields present",
        requiredConnectorIds: ["servicenow-bt1", "github-issues"],
        optionalConnectorIds: ["knowledge-plane", "playwright"]
      },
      setupGuide: {
    ...
    },
    {
      ...
      workflowAdmin: {
        workflowFile: ".github/workflows/story-delivery.yml",
        activationState: "active",
        retryCount: 1,
        maxConcurrency: 3,
        triggerConditions: "Enhancement semantics, acceptance criteria present, repo hints available",
        requiredConnectorIds: ["github-issues"],
        optionalConnectorIds: ["knowledge-plane", "playwright"]
      },
      setupGuide: {
    ...
    },
    {
      ...
      workflowAdmin: {
        workflowFile: ".github/workflows/case-resolution.yml",
        activationState: "active",
        retryCount: 1,
        maxConcurrency: 2,
        triggerConditions: "Support labels, customer impact, environment notes present",
        requiredConnectorIds: ["servicenow-bt1"],
        optionalConnectorIds: ["knowledge-plane"]
      },
      setupGuide: {
    ...
    },
    {
      ...
      workflowAdmin: {
        workflowFile: ".github/workflows/connector-onboarding.yml",
        activationState: "inactive",
        retryCount: 1,
        maxConcurrency: 1,
        triggerConditions: "Connector chosen, schema mapping complete, sample item bound",
        requiredConnectorIds: ["enterprise-template"],
        optionalConnectorIds: ["knowledge-plane"]
      },
      setupGuide: {
